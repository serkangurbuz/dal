...
/**
 * OturumSetSoruOlcmeDogruyanlisId generated by hbm2java
 */
public class OturumSetSoruOlcmeDogruyanlisId implements java.io.Serializable {
	...
	public OturumSetSoruOlcmeDogruyanlisId() {
	}

	public OturumSetSoruOlcmeDogruyanlisId(long cihazKod, long oturumKod,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OturumSetSoruOlcmeDogruyanlisId))
			return false;
		OturumSetSoruOlcmeDogruyanlisId castOther = (OturumSetSoruOlcmeDogruyanlisId) other;
